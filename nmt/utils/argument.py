...
def get_main_argument(desc='Train Transformer'):
    ...
    parser.add_argument('--project_raw_dir', type=str, default="")
    parser.add_argument('--project_processed_dir', type=str, default="")
    ...
    parser.add_argument('--phase', type=str, choices=['preprocess', 'train', 'predict', 'val'], default='train')
