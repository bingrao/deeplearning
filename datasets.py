...
if __name__ == "__main__":
    ...
    TranslationDataset.prepare(config["train_source"],
                               config["train_target"],
                               config["val_source"],
                               config["val_target"],
                               config["save_data_dir"])
    translation_dataset = TranslationDataset(config["save_data_dir"], 'train')
    ...
    tokenized_dataset = TokenizedTranslationDataset(config["save_data_dir"], 'train')
    ...
    IndexedInputTargetTranslationDataset.prepare(config["save_data_dir"],
                                                 source_dictionary,
                                                 target_dictionary)
    indexed_translation_dataset = IndexedInputTargetTranslationDataset(config["save_data_dir"],
                                                                       'train')
    indexed_translation_dataset_on_the_fly = IndexedInputTargetTranslationDatasetOnTheFly('train',
                                                                                          source_dictionary,
                                                                                          target_dictionary)
