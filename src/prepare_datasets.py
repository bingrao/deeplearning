...
if os.getenv("Project_Home") is not None:
    Projec_Base = os.environ["Project_Home"]
else:
    Projec_Base = dirname(abspath(__file__))


from argparse import ArgumentParser

parser = ArgumentParser('Prepare datasets')
parser.add_argument('--train_source', type=str, default=Projec_Base+'/data/example/raw/src-train.txt')
parser.add_argument('--train_target', type=str, default=Projec_Base+'/data/example/raw/tgt-train.txt')
parser.add_argument('--val_source', type=str, default=Projec_Base+'/data/example/raw/src-val.txt')
parser.add_argument('--val_target', type=str, default=Projec_Base+'/data/example/raw/tgt-val.txt')
parser.add_argument('--save_data_dir', type=str, default=Projec_Base+'/data/example/processed')
